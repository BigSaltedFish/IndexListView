 ...
 * 滑动定位帮助类
 */
public class IndexScrollHolder extends RecyclerView.OnScrollListener {
    ...
    public static IndexScrollHolder newInstance(RecyclerView recyclerView) {
        return new IndexScrollHolder(recyclerView, null);
    }

    public static IndexScrollHolder newInstance(RecyclerView recyclerView, Delegate delegate) {
        return new IndexScrollHolder(recyclerView, delegate);
    }

    private IndexScrollHolder(RecyclerView recyclerView, Delegate delegate) {
